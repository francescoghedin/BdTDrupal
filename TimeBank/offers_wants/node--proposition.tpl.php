 ...
 * $convert_link is a link to a prefilled transaction form - see mutual_credit package
 * $body
 */
if ($teaser) {
...
<div class = "<?php print $classes; ?>">
  ...
  <div class = "proposition-links">
    <?php if ($GLOBALS['user']->uid) print $user_picture; ?>
  ...
  <?php print render($field_dammi_il_percorso); ?>
  <hr />
